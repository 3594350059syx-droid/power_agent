...
try:
    ...
    from agent.tools.predict_tool import predict_tool as _real_predict_tool
    _REAL_REGISTRY["data_tool"] = _real_data_tool
    _REAL_REGISTRY["alarm_tool"] = _real_alarm_tool
    _REAL_REGISTRY["predict_tool"] = _real_predict_tool
    logger.info("B 的真实 Tool 实现已加载（data_tool, alarm_tool, predict_tool）")
...
ACTIVE_REGISTRY = {
    ...
    "predict_tool": _REAL_REGISTRY.get("predict_tool", predict_tool_mock),   # P1-1 已完成，优先真实实现
